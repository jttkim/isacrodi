...
<s:push value="%{expertDiagnosedCropDisorder}"><%@include file="components/links/cropdisorderlink.jsp" %></s:push>
</s:if>
<s:else>
none
</s:else>
<span class="todonote">link to expert edit form here</span>
</td>
</tr>
